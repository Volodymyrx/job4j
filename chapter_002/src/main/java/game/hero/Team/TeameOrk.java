...
import game.hero.hero.HeroMagOrk;
...
public class TeameOrk implements Teame {
    ...
    public TeameOrk(int quantityMag, int quantityGun, int quantitySworder) {
        this.teameBase = new TeameBase();
        for (int i = 0; i < quantityMag; i++) {
            teamHeros.add(new HeroMagOrk("Mag Ork" + i, "Magic and Sword", 10, 100));
        }
