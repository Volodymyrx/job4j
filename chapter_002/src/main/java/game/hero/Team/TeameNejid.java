...
public class TeameNejid implements Teame {
    private final String name = "Team Nejid";
    private final Teame teameBase;
    private ArrayList<Hero> teamHeros = new ArrayList<>();

    public TeameNejid() {
        this.teameBase = new TeameBase();
        teamHeros.add(new HeroMagElf("Mag Nejid", "Magic and Sword", 5, 100));
        teamHeros.add(new HeroHunter("Hunter 1", "Gun and Sword", 2, 4, 100));
        teamHeros.add(new HeroHunter("Hunter 2", "Gun and Sword", 2, 4, 100));
        teamHeros.add(new HeroHunter("Hunter 3", "Gun and Sword", 2, 4, 100));
