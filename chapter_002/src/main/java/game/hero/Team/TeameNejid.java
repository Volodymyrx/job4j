...
import game.hero.hero.HeroMagNejid;
...
public class TeameNejid implements Teame {
    ...
    public TeameNejid(int quantityMag, int quantityGun, int quantitySworder) {
        this.teameBase = new TeameBase();
        for (int i = 0; i < quantityMag; i++) {
            teamHeros.add(new HeroMagNejid("Mag Nejid" + i, "Magic and Sword", 10, 100));
        }
